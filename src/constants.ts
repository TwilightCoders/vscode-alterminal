...
export const DEBOUNCE_TIMINGS = {
  TERMINAL_WRITE: 600,
  TERMINAL_WRITE_MAX_WAIT: 4000,
  TERMINAL_DATA: 750,
  TERMINAL_DATA_MAX_WAIT: 5000,
  TERMINAL_RESIZE: 50,
  TERMINAL_CLEAR: 500,
  TERMINAL_CLEAR_MAX_WAIT: 1000,
  GLOBAL_STATE_SAVE: 400,
  GLOBAL_STATE_SAVE_MAX_WAIT: 4000,
  BACKUP_STATE_SAVE: 500,
  BACKUP_STATE_SAVE_MAX_WAIT: 1000,
} as const;
