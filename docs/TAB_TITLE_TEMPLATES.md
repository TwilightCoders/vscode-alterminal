...
```json
{
  "alterminal.tabTitle.template": "{n}{p? • {p}}",
  "alterminal.tabTitle.updateInterval": 1000,
  "alterminal.tabTitle.maxLength": 50,
  "alterminal.tabTitle.truncateMode": "middle"
}
```
...
```json
{
  "alterminal.tabTitle.template": "{cwd} ~ {p:shell}",
  "alterminal.tabTitle.workspaceTemplate": true
}
```
...
```
> Alterminal: Set Tab Title Template
> Alterminal: Reset Tab Title Template
> Alterminal: Preview Tab Title Template
> Alterminal: Copy Current Tab Template
```
